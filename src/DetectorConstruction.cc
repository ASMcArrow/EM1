...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
    ...
    // Phantom
    G4Box *phantom = new G4Box("Phantom", 100*cm, 100*cm, 100*cm);
    WLogic = new G4LogicalVolume(phantom, MaterialMap["Water"], "PhantomLogic");
    new G4PVPlacement(0, G4ThreeVector(0, 0, 100*cm), WLogic, "PhantomPhys", worldLogic, 0, 0);
